...
export default async function News({ params }: { params: Params }) {
  ...
  return (
    <main className="mx-auto flex w-full max-w-[960px] flex-col gap-8 px-4 pt-[120px] md:flex-row-reverse">
      <NewsLinkBadges className="w-full self-start md:sticky md:top-[120px] md:w-[240px]" />
